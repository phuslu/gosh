...
> Vendored into gosh from `github.com/ergochat/readline` @ `16c2b71`
> (fork of `github.com/chzyer/readline`), with two local modifications:
>
> - the DSR-CPR cursor position probe was removed; the prompt is assumed to
>   start at column 1, matching the behavior of chzyer/readline;
> - `Instance.SetBufferWithCursor(line, pos)` was added to prefill the edit
>   buffer at a specific cursor offset.
